...
function LoadingComponent({ loading }) {
  ...
  return (
    <div className={`flex flex-col justify-center items-center h-screen transition-opacity duration-300 z-50 absolute w-screen bg-white ${loading ? 'opacity-100' : 'opacity-0'}`}>
